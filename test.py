...
def main():
    ...
    datamodule = SceneTextDataModule(args.data_root, '_unused_', hp.img_size, hp.max_label_length, charset_test,
            charset_test, args.batch_size, args.num_workers, False, rotation=args.rotation, remove_whitespace = False, normalize_unicode  = False)
    ...
    test_set = ['document_test', 'scene_test', 'web_test', 'handwriting_ic13_test', 'game_lmdb']
    #test_set = ['game_lmdb']
    print(test_set)
